...
async def forward_messages(client, message):
    try:
        if message.from_user.id != 1733124290: return await client.send_message(1733124290, f"🚨 Link tried by {message.from_user.first_name}", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("👤 User", user_id=message.from_user.id)]]))
